...
{
    // number of remote docs is not an integer of 100, which is the default batch size of docs fetched
    ...
    // not equal it's limit, ensuring that there will at least be one more HTTP call after
    // all changes were pulled. We need to make sure that the replicator thread handles this
    // situation properly.
